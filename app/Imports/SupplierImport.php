...
class SupplierImport implements ToCollection, WithHeadingRow, WithStartRow
{
    protected $fields;
    ...
    protected function importRow(array $row)
    {
        ...
        $validated = Supplier::validate($row, $row['id']);
        if ($validated->fails()) {
            throw new \Exception($validated->errors()->first());
        }
        Supplier::updateOrCreate(['id' => $row['id']], ['name' => $row['name']]);
    }
}
